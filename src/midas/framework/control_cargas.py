...
class ControlCargasClient:
    ...
    def __init__(
        ...
        # Discriminador: midas_control_cargas / midas_log_cargas son COMPARTIDAS
        # con otros jobs (p. ej. vera_framework). Sin este filtro cada job leeria
        # las filas del otro.
